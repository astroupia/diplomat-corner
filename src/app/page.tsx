...
=======
                  <div className="w-full h-[420px] bg-gray-200 rounded animate-pulse"></div>
>>>>>>> d5eb80e51b9bfa8f4266a0ba8e9a677d918f59f5
                </div>
              </div>
...
=======
            <div className="h-[330px] w-full rounded-3xl bg-gray-200 animate-pulse"></div>
>>>>>>> d5eb80e51b9bfa8f4266a0ba8e9a677d918f59f5
          </div>
        </MaxWidthWrapper>
      </section>
      ...
      <section className="bg-slate-50 py-10">
        <MaxWidthWrapper className="flex flex-col md:flex-row items-center gap-6 p-6 rounded-lg shadow-md mx-auto">
          <div className="flex-shrink-0 w-full sm:w-[500px]">
            <div className="relative">
              <div className="rounded-lg w-full h-[500px] bg-gray-200 animate-pulse"></div>
            </div>
          </div>
      ...
      <MaxWidthWrapper className="flex flex-col md:flex-row items-center gap-6 p-6 rounded-lg shadow-md mx-auto">
        ...
        <div className="flex-1 mt-4 md:mt-0">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            selling duty-free cars, searching for houses to rent, or looking to
            rent out your car, we&apos;ve got you covered. Connect with us to
            explore these services and much more.
          </p>
        </div>
      </MaxWidthWrapper>
    </section>
